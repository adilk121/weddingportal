...
<title><?=db_scalar("SELECT site_pages_meta_title FROM tbl_site_pages WHERE  site_pages_link='terms-and-conditions' AND site_pages_status='Active'")?></title>
<meta name="description" content="<?=db_scalar("SELECT site_pages_meta_description FROM tbl_site_pages WHERE  site_pages_link='terms-and-conditions' AND site_pages_status='Active'")?>">
<meta name="keywords" content="<?=db_scalar("SELECT site_pages_meta_keyword FROM tbl_site_pages WHERE  site_pages_link='terms-and-conditions' AND site_pages_status='Active'")?>">
  ...
  <section style="background:url(images/bg1.jpg) no-repeat center; background-size:cover; padding:20px;">
   <div class="container">
      <div class="col-md-12 text-center bg_1">
        ...
        <p><a href="<?=SITE_WS_PATH?>">Home</a> | Terms & Conditions
      </div>
   </div>
 </section>
...
<?=db_scalar("SELECT site_pages_description FROM tbl_site_pages WHERE  site_pages_link='terms-and-conditions' AND site_pages_status='Active'")?>
