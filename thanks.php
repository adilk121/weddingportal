...
if(isset($_POST["proceedpayment"])){
     ...
     //  $sql_ID =mysqli_fetch_array($last_id_q);
        ...
        $payload = Array(
            'purpose' => 'Admission',
            'amount' => '350',
            'phone' => db_scalar("select reg_member_mobile from tbl_registration where reg_id='$_SESSION[userLoginId]' "),
            'buyer_name' => db_scalar("select reg_name from tbl_registration where reg_id='$_SESSION[userLoginId]' "),
            'redirect_url' => 'https://thebestweddinghub.com/thanks.php',
            'send_email' => true,
            'send_sms' => true,
            'email' => db_scalar("select reg_email from tbl_registration where reg_id='$_SESSION[userLoginId]' "),
        ...
        $_SESSION['PName']=db_scalar("select reg_name from tbl_registration where reg_id='$_SESSION[userLoginId]' ");
        $_SESSION['plid']=$last_id_q;
