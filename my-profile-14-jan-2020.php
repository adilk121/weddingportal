...
?> 
  <!---button--->
  <style>
  .my-pro img{width:100%; border:solid 1px #efefef; border:solid 1px #ccc; height:auto !important;}
	  .view-sty {
    display: block;
    color: #000 !important;
    font-size: 14px;
  ...
  <section style="background-color:#f1f1f2;">
    <div class="container">
      ...
      <div class="col-md-3 my-pro text-center">
		   <div class="col-md-12 col-xs-12 pro-bg" style="background-color:#f1f7f0; margin:0px; padding: 0px; box-shadow: 1px 1px 10px #ccc; height: 327px !important;">
        <?php 
       ...
       <?php }?>
        ...
        <div class="col-md-12 col-xs-12 pro-bg" style="background-color:#f1f7f0;  padding: 4px;">
        
    <?    
    if($userDATA['reg_profile_photo']=="")
        {?>    
        <div class="col-md-12 col-xs-12 mp03 text-center"><a href="Javascript:void(0)" onClick ="PopupWindowCenter('manage-profile-photo.php?memId=<?=$userDATA['reg_id']?>', 'PopupWindowCenter',800,500);" class="view-sty"><i class="fa fa-plus-square-o"></i> Add Profile Photo</a></div>
        <?}else{?>
        
        <div class="col-md-4 col-xs-4 text-center mp03"><a href="Javascript:void(0)" data-toggle="modal" data-target="#ProfilePhotoModal" class="view-sty"><i class="fa fa-camera"></i> View</a></div>
			
        
              <div class="col-md-1 col-xs-1 syb">|</div>
        <div class="col-md-6 col-xs-6 mp03 text-center"><a href="Javascript:void(0)" onClick ="PopupWindowCenter('manage-photo.php?memId=<?=$userDATA['reg_id']?>', 'PopupWindowCenter',800,500);" class="view-sty"><i class="fa fa-plus-square-o"></i> Add Photo</a></div>
      ...
      <!---end-images--->
       ...
       <div class="col-md-6 bg-wth b-dtl" style="margin-top:0px; margin-right:0px; padding-top:2px;">
  ...
  <!--Profile Completion calculation End-->
       ...
       <div class="col-md-12" style="margin-right:0px; padding:0px;">
         <div class="SkillBar-stripescol-md-12 my-pro1 text-center" style="padding:0px 0px;">
    
        <div id="doughnutChart" class="chart"></div>
        <!-------->
        <div class="col-md-7 text-center prostd" style="padding:15px 0px;">
      ...
      <!---<p>Last Edited on <?//=date("d M",strtotime($userDATA['reg_last_edit_date']))?>, <?//=date("Y",strtotime($userDATA['reg_last_edit_date']))?><br>
        ...
        <div class="col-md-5 text-center prostd">
...
<div class="col-md-12 bg-wth b-dtl" style="padding:0px; padding-bottom:3px;">
...
<input type="hidden" name="edit_contact" value="edit-contact" />
         ...
         <!------------>
         <div class="col-md-12 mp-02 pd-left">
        ...
        <div class="col-md-1 hidden-xs" style="margin-top:-10px;">
          <div class="col-md-12">
      ...
      <i class="fa fa-user crcle-icon" style="color:#C60"></i>
       ...
       <img src="images/book.png" class="crcle-icon" style="padding:10px;">
      ...
      <div class="col-md-12 bg-wth b-dtl sdow">
      ...
      <div class="col-md-2 col-xs-2 wd-btn">
...
<div class="col-md-12" id="member-myself" >
<p style="text-align:justify;"><?=$userDATA['reg_mem_myself']?></p>
</div>

<div class="col-md-12" id="member-myself-edit" style="display:none" >
...
<div class="col-sm-12 no-padd" id="member-basic-detail" >
...
<div class="col-sm-12 no-padd" id="member-basic-detail-edit" style="display:none" >
<div class="col-md-6 col-xs-6 mp_1">
<div class="col-md-5 col-xs-5 agd">
<h5>Full Name</h5>
</div>
...
<div class="col-sm-12 no-padd" id="member-location">
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Country</h5>
</div>
...
<div class="col-sm-12 no-padd" id="member-location-edit" style="display:none">
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Country</h5>
</div>
...
<div class="col-sm-12 no-padd" id="member-family">
...
<div class="col-sm-12 no-padd" id="member-family-edit" style="display:none" >
<div class="col-md-4 mp_1">
<div class="col-md-5 agd">
<h5>Father's Status</h5>
</div>
...
<div class="col-sm-12 no-padd" id="member-edu" >
<div class="col-md-4 mp_1">
<div class="col-md-5 agd">
...
<div class="col-sm-12 no-padd" id="member-edu-edit" style="display:none" >
<div class="col-md-4 mp_1">
<div class="col-md-5 agd">
<h5>Highest&nbsp;Education</h5>
</div>
...
<div class="col-sm-12 no-padd" id="member-religion">
<div class="col-md-4 mp_1">
<div class="col-md-5 agd">
<h5>Religion</h5>
</div>
...
<div class="col-sm-12 mb-10 no-padd" id="member-religion-edit" style="display:none">
<div class="col-md-4 mp_1">
<div class="col-md-5 agd">
<h5>Religion</h5>
</div>
...
<div class="col-sm-12 no-padd" <?php ?><?php if(!empty($userDATA['reg_religion']) && $userDATA['reg_religion']=="Muslim"){?>style="display:block"<?php }else{?>style="display:none"  <?php }?><?php ?> id="muslim">      
...
<div class="col-sm-12 no-padd" id="member-lifestyle-edit" style="display:none">
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Appearance</h5>
</div>
...
<div class="col-sm-12 no-padd" id="member-like" >
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Hobbies</h5>
</div>
...
<div class="col-sm-12 no-padd" id="member-like-edit" style="display:none" >
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Hobbies</h5>
</div>
...
<div class="col-md-12" id="member-partner-myself" >
<p style="text-align:justify;"><?=$userDATA['reg_preference_mem_myself']?></p>
</div>

<div class="col-md-12 mb15" id="member-partner-myself-edit" style="display:none" >
...
<div class="col-sm-12 no-padd" id="member-partner-basic">
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Marital Status</h5>
</div>
...
<div class="col-sm-12 no-padd" id="member-partner-basic-edit" style="display:none">
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Marital Status</h5>
</div>
...
<div class="col-sm-12 no-padd mb-15" id="member-partner-religion">
<div class="col-md-4 mp_1">
<div class="col-md-5 agd">
<h5>Religion</h5>
</div>
...
<div class="col-md-8 mp_1" <?php if($userDATA['reg_preference_religion']=="Parsi" || $userDATA['reg_preference_religion']=="Buddhist" || $userDATA['reg_preference_religion']=="Jewish" ){?> style="display:none" <?php }?>  >
...
<div class="col-sm-12 mb-15 no-padd" id="member-partner-religion-edit" style="display:none">
<div class="col-md-4 mp_1">
<div class="col-md-5 agd">
<h5>Religion</h5>
</div>
...
<div class="col-md-8 mp_1" id="community_load_area_partner" 
...
<div class="col-sm-12 no-padd" id="member-partner-location">
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Country</h5>
</div>
...
<div class="col-sm-12 no-padd" id="member-partner-location-edit" style="display:none">
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Country</h5>
</div>
...
<div class="col-sm-12 no-padd" id="member-partner-professional" >
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Highest Education</h5>
</div>
...
<div class="col-sm-12 no-padd profile-common-edit" id="member-partner-professional-edit" style="display:none" >
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Highest Education</h5>
</div>
...
<div class="col-sm-12 no-padd" id="member-partner-lifestyle">
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Appearance</h5>
</div>
...
<div class="col-sm-12 no-padd" id="member-partner-lifestyle-edit" style="display:none">
<div class="col-md-6 mp_1">
<div class="col-md-5 agd">
<h5>Appearance</h5>
</div>
