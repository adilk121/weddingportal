...
<p><a href="Javascript:void(0)" onClick="PopupWindowCenter('view-faq.php?faq_id=<?=$line_raw["faq_id"]?>', 'PopupWindowCenter',400,320)"><i class="fa fa-search-plus fa-lg pull-left" style="color:#000"></i>&nbsp; <?=$line_raw["faq_ques"]?> </a></p>
</td>
