...
if($st==1){
$sql="UPDATE tbl_community SET c_status='Inactive' WHERE c_id='$subcatID' ";	
$res=db_query($sql);	
if($res>0){
$_SESSION["msg"]="Selected community is deactivated successfully.";	
}	
}else{
$sql="UPDATE tbl_community SET c_status='Active' WHERE c_id='$subcatID' ";	
$res=db_query($sql);	
if($res>0){
$_SESSION["msg"]="Selected community is activated successfully.";	
}	
...
$sql = "select * from  tbl_community   where 1 and c_parent_id='$catID'";
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                 ...
                 <a href="addedit-community.php?id=0&catID=<?=$catID?>"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
<span class="btn-label"><i class="fa fa-plus" aria-hidden="true"></i>
</span>Add Community
</button></a>

<a href="religion_list.php"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 mr10 pull-right">
<span class="btn-label"><i class="fa fa-chevron-left" aria-hidden="true"></i>
</span>Back
</button></a>

<span class="count-num">Total : <?=db_scalar("SELECT COUNT(c_id) FROM tbl_community WHERE 1 AND c_parent_id='$_REQUEST[catID]'")?></span>
                     ...
                     <div class="panel panel-bd lobidrag" data-edit-title='false' data-close='false' data-reload='false'>
                        ...
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4 class="font-black">Community List</h4>
                              </a>
                           </div>
                        </div>
...
<?php /*?><td class="text-center v-middle"><a href="subcommunity_list.php?rID=<?=$line_raw["c_parent_id"]?>&cID=<?=$line_raw["c_id"]?>"><?=$line_raw["c_title"]?> <i class="fa fa-arrow-right"></i></a></td><?php */?>
  
  
<td class="text-center v-middle bold"><?=$line_raw["c_title"]?></td>  
                                     
<?php /*?><td class="text-center v-middle">
<a href="addedit-subcommunity.php?scID=0&rID=<?=$line_raw["c_parent_id"]?>&cID=<?=$line_raw["c_id"]?>"><button type="button" class="btn btn-info btn-outline w-md m-b-5 bold"><i class="fa fa-plus font-black">&nbsp;&nbsp;</i></span>Add Sub-Community</button></a>
</td><?php */?>


<td class="text-center v-middle">
<?php if($line_raw["c_status"]=="Active"){?>
<a href="community_list.php?st=1&pid=<?=$line_raw["c_id"]?>"><span class="label-custom label label-default">Active</span></a>
<?php }else{?>
<a href="community_list.php?st=0&pid=<?=$line_raw["c_id"]?>"><span class="label-danger label label-default">Inactive</span></a>
<?php }?>
...
<td class="text-center v-middle">
<a href="addedit-community.php?id=<?=$line_raw["c_id"]?>&catID=<?=$catID?>"><button type="button" class="btn btn-add btn-sm" ><i class="fa fa-pencil"></i></button>
</a>                                          
</td>
