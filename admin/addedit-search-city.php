...
$sql = "update   tbl_search_city set        
				m_title='$m_title',
				m_status='$m_status'
				where m_id = '$m_id' ";
...
$_SESSION["msg"]="City Is Updated Successfully !";
header("Location:addedit-search-city.php?id=$_REQUEST[id]");
exit;
//*************** UPDATE EXISTING CATEGORY END ************************//
}else{

////////////****************** IMAGE RESIZING END HERE *****************************//
$sql = "insert into   tbl_search_city set 
				m_title='$m_title',
				m_status='$m_status'
				";
				
db_query($sql);
$_SESSION["msg"]="City Is added successfully !";
header("Location:addedit-search-city.php?id=$_REQUEST[id]");
exit;
...
if($m_id!='') {
	$result = db_query("select * from   tbl_search_city where m_id = '$m_id'");
...
<a href="manage-search-city.php"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
