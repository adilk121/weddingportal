...
$sql = "select * from  tbl_community   where 1 and c_parent_id='$cID'";
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Sub Community</h1>
                  <small>Sub Community List</small>
...
<a href="addedit-subcommunity.php?scID=0&rID=<?=$rID?>&cID=<?=$cID?>"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
<span class="btn-label"><i class="fa fa-plus" aria-hidden="true"></i>
</span>Add Sub Community
</button></a>

<a href="community_list.php?catID=<?=$rID?>"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 mr10 pull-right">
                     ...
                     <div class="panel panel-bd lobidrag" data-edit-title='false' data-close='false' data-reload='false'>
                        ...
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4 class="font-black">Sub Community List</h4>
                              </a>
                           </div>
                        </div>
...
<td class="text-center v-middle"><a href="subcommunity_list.php?rID=<?=$line_raw["c_parent_id"]?>&cID=<?=$line_raw["c_id"]?>"><?=$line_raw["c_title"]?> <i class="fa fa-arrow-right"></i></a>
...
<a href="addedit-community.php?id=0&rID=<?=$line_raw["c_parent_id"]?>&cID=<?=$line_raw["c_id"]?>"><button type="button" class="btn btn-info btn-outline w-md m-b-5 bold"><i class="fa fa-plus font-black">&nbsp;&nbsp;</i></span>Add Sub-Community</button></a>
