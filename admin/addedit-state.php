...
header("Location:addedit-state.php?id=$_REQUEST[id]&cntyID=$cntyID");
exit;
//*************** UPDATE EXISTING CATEGORY END ************************//
}else{

////////////****************** IMAGE RESIZING END HERE *****************************//
$sql = "insert into  tbl_state set 
				state='$state',	
				country_id='$cntyID',
				status='$status'
				";
...
if($state_id!='') {
	$result = db_query("select * from  tbl_state where state_id = '$state_id'");
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Add/Edit State</h1>
                  <small>Add/Edit State</small>
                  
                  
<a href="state-list.php?catID=<?=$cntyID?>"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
...
<input type="text" class="form-control" placeholder="Enter Name" name="state" id="state"  value="<?=$state?>">
                              </div>
