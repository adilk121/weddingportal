...
if($st==1){
$sql="UPDATE tbl_search_state SET m_status='Inactive' WHERE m_id='$catID' ";	
$res=db_query($sql);	
if($res>0){
$_SESSION["msg"]="Selected state is deactivated successfully.";	
}	
}else{
$sql="UPDATE tbl_search_state SET m_status='Active' WHERE m_id='$catID' ";	
$res=db_query($sql);	
if($res>0){
...
if(is_post_back()) {
	...
	if(isset($_REQUEST['Update'])){
		...
		db_query("update tbl_search_state set c_order_by ='$value' where m_id='$key'");
		}
	}
...
$sql = "select * from  tbl_search_state   where 1 ";
...
<a href="addedit-search-state.php?id=0"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
<span class="btn-label"><i class="fa fa-plus" aria-hidden="true"></i>
</span>Add State
</button></a>

<span class="count-num">Total : <?=db_scalar("SELECT COUNT(m_id) FROM tbl_search_state")?></span>
                     ...
                     <div class="panel panel-bd lobidrag" data-edit-title='false' data-close='false' data-reload='false'>
                        ...
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4 class="font-black">Mother State List</h4>
                              </a>
                           </div>
                        </div>
...
<a href="manage-state.php?st=1&pid=<?=$line_raw["m_id"]?>"><span class="label-custom label label-default">Active</span></a>
<?php }else{?>
<a href="manage-state.php?st=0&pid=<?=$line_raw["m_id"]?>"><span class="label-danger label label-default">Inactive</span></a>
<?php }?>
...
<td class="text-center v-middle">
<a href="addedit-search-state.php?id=<?=$line_raw["m_id"]?>"><button type="button" class="btn btn-add btn-sm" ><i class="fa fa-pencil"></i></button>
</a>                                          
</td>
