...
$_SESSION["msg"]="Mother Toung Is Updated Successfully !";
header("Location:addedit-toung.php?id=$_REQUEST[id]");
exit;
//*************** UPDATE EXISTING CATEGORY END ************************//
}else{

////////////****************** IMAGE RESIZING END HERE *****************************//
$sql = "insert into  tbl_toung set 
				m_title='$m_title',
				m_status='$m_status'
				";
				
db_query($sql);
$_SESSION["msg"]="Mother Toung Is added successfully !";
header("Location:addedit-toung.php?id=$_REQUEST[id]");
exit;
...
if($m_id!='') {
	$result = db_query("select * from  tbl_toung where m_id = '$m_id'");
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Add/Edit Mother Toung</h1>
                  <small>Add/Edit Mother Toung</small>
                  
                  
<a href="manage-mother-toung.php"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
