...
if(is_post_back()) {
	...
	$_SESSION["msg"]="Selected testimonial order is set.";	
...
$order_by == '' ? $order_by = 'test_status' : true;
$order_by2 == '' ? $order_by2 = 'asc' : true;
 
$sql = "select * from  tbl_testimonial   where 1 ";
$sql = apply_filter($sql, $testimonial_name, 'like','test_given_by');
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                 ...
                 <a href="add-edit-testimonial.php?id=0"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
                     ...
                     <div class="panel panel-bd lobidrag" data-edit-title='false' data-close='false' data-reload='false'>
                        ...
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4 style="color:black">Testimonial List</h4>
                              </a>
                           </div>
                        </div>
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 <thead>
                                    <tr class="info">                                      
                                       ...
                                       <th class="text-center">Given By/Company Name</th>                                       
...
<img src="<?=SITE_WS_PATH?>/test_images/<?=$test_image_name?>"  class="thumbnail" style="width:65px;height:65px; margin-top:0;margin-bottom:0" />
<?php }else{?>
