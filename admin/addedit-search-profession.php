...
$sql = "update   tbl_search_profession set        
				m_title='$m_title',
				m_status='$m_status'
				where m_id = '$m_id' ";
...
$_SESSION["msg"]="Profession Is Updated Successfully !";
header("Location:addedit-search-profession.php?id=$_REQUEST[id]");
exit;
//*************** UPDATE EXISTING CATEGORY END ************************//
}else{

////////////****************** IMAGE RESIZING END HERE *****************************//
$sql = "insert into   tbl_search_profession set 
				m_title='$m_title',
				m_status='$m_status'
				";
				
db_query($sql);
$_SESSION["msg"]="Profession Is added successfully !";
header("Location:addedit-search-profession.php?id=$_REQUEST[id]");
exit;
...
if($m_id!='') {
	$result = db_query("select * from   tbl_search_profession where m_id = '$m_id'");
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Add/Edit Profession</h1>
                  <small>Add/Edit Profession 	</small>
                  
                  
<a href="manage-profession.php"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
