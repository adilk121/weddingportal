...
header("Location:addedit-community.php?id=$_REQUEST[id]&catID=$catID");
exit;
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Add/Edit Community</h1>
                  <small>Add/Edit Community</small>
                  
                  
<a href="community_list.php?catID=<?=$catID?>"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
