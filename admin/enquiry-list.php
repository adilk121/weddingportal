                     ...
                     <div class="panel panel-bd lobidrag" data-edit-title='false' data-close='false' data-reload='false'>
                        ...
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4 style="color:black">Enquiry List</h4>
                              </a>
                           </div>
                        </div>
...
<td class=" v-middle">
<p><a href="Javascript:void(0)" onClick="PopupWindowCenter('view-enquiry.php?enquiry_id=<?=$line_raw["enquiry_id"]?>', 'PopupWindowCenter',400,320)"><i class="fa fa-search-plus fa-lg pull-left" style="color:#000"></i>&nbsp; <?=$line_raw["enquiry_name"]?> </a></p>
</td>
...
<h5 class="source-title">Enquiry From <?=$line_raw["enquiry_source"]?> </h5></div>
