...
if(!empty($delImageID)){ 
   $imageToDel=db_scalar("select image_name from  tbl_image_gallery where 1 and image_id='$delImageID'"); 
   @unlink('../gallery_image/'.$imageToDel);
   $sqldel="delete from tbl_image_gallery where 1 and image_id='$delImageID'";
   db_query($sqldel);
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Gallery Image</h1>
                  <small>Gallery Image List</small>
...
<span class="count-num">Total : <?=db_scalar("SELECT COUNT(image_id) FROM tbl_image_gallery WHERE 1")?></span>
...
<?php			
			  $sql_fetch = db_query("select * from tbl_image_gallery where 1 ");
             ...
             <img src="../gallery_image/<?=$DATA['image_name']?>" class="img-thumbnail" width="140" height="140" />
            <span style="font-weight:bold;"><?=$DATA['image_title']?></span>
	
    <div class="col-lg-12 text-center" style="margin-top:10px" ><a href="image-list.php?DelID=<?=$DATA['image_id']?>"><i class="fa fa-trash fa-2x" style="color:#F00"></i></a></div>
          </div>		  
			 <? }} ?>
			 <div class="cb"></div>
			 </div>
