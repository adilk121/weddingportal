...
$_SESSION["msg"]="Marital Status Is Updated Successfully !";
header("Location:addedit-marital.php?id=$_REQUEST[id]");
exit;
//*************** UPDATE EXISTING CATEGORY END ************************//
}else{

////////////****************** IMAGE RESIZING END HERE *****************************//
$sql = "insert into  tbl_marital set 
				m_title='$m_title',
				m_status='$m_status'
				";
				
db_query($sql);
$_SESSION["msg"]="Marital Status Is added successfully !";
header("Location:addedit-marital.php?id=$_REQUEST[id]");
exit;
...
if($m_id!='') {
	$result = db_query("select * from  tbl_marital where m_id = '$m_id'");
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Add/Edit Marital Status</h1>
                  <small>Add/Edit Marital Status</small>
                  
                  
<a href="manage-marital-status.php"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
