...
$sql="SELECT * FROM tbl_registration WHERE reg_gender='$gender' AND reg_status='Active' AND reg_id IN ($shortMemIds) ";	

}

/////////////////  SHORT LISTED PROFILE END ///////////////////	



/////////////////  SUITABLE PROFILE START ///////////////////	
if($match=="suitable-match"){	
$sql="SELECT * FROM tbl_registration WHERE reg_gender='$gender' AND reg_status='Active' ";	
}
/////////////////  SUITABLE PROFILE END ///////////////////	
...
/////////////////  NEW MATCHES PROFILE START ///////////////////	
if($match=="new"){	

$sql="SELECT * FROM tbl_registration WHERE reg_gender='$gender' AND reg_status='Active' ORDER BY reg_add_date DESC ";	

}
/////////////////  SUITABLE PROFILE END ///////////////////	


/////////////////  recent Update MATCHES PROFILE START ///////////////////	
if($match=="recent"){	

$sql="SELECT * FROM tbl_registration WHERE reg_gender='$gender' AND reg_status='Active' ORDER BY reg_last_edit_date DESC ";	

}
/////////////////  recent Update PROFILE END ///////////////////

/////////////////  PREMIUM MEMBER MATCHES PROFILE START ///////////////////	
if($match=="premium_member"){
   
$check_date=date("Y-m-d");
 $sql="SELECT * FROM tbl_registration WHERE reg_gender='$gender' AND reg_status='Active' AND '$check_date'>=reg_membership_start_date AND '$check_date'<=reg_membership_expiry_date ORDER BY reg_last_edit_date DESC ";	
}
/////////////////  PREMIUM MEMBER MATCHES PROFILE END ///////////////////
...
if($matchCount>0 && $match=="suitable-match"){
?>       
...
////////////////  FOR suitable-match END  ////////////////////
?>


<?php
/////////////////////  FOR MUTUAL MATCHES START ///////////////////
if($matchCount>0 && $match=="mutual"){
?>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-pro1">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-lstd1" style="margin:0px; padding:0px;">
<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 " style="margin:0px; padding:0px;">
...
if($matchCount>=0 && $match=="recommendation"){
$matchCount=0;	
?>       
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-pro1">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-lstd1" style="margin:0px; padding:0px;">
...
<!-- ////////////////  FOR SHORT LIST START  //////////////////// -->

<?php if($match=="short"){?>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-pro1">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-lstd1" style="margin:0px; padding:0px;">
<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="margin:0px; padding:0px;">
<a href="other-profile.php?mem=<?=$recMember['reg_id']?>" target="_blank"><h4> <span class="pcid">(AMRGD<?=$recMember['reg_id']?> | Profile Created for <?=$recMember['reg_for']?>)</span></h4></a>
</div>
<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 txt-rg">
<?php if($_SESSION['userLoginId']!=""){?>
<a href="other-profile.php?mem=<?=$recMember['reg_id']?>" target="_blank"><h4><i class="fa fa-mobile"></i> +91-xxxxxxxxxx</h4></a>
<?php }else{?>
<a href="other-profile.php?mem=<?=$recMember['reg_id']?>" target="_blank"><h4><i class="fa fa-mobile"></i> +91-xxxxxxxxxx</h4></a>
<?php }?>
</div>
...
<!-- ////////////////  FOR PREMIUM PROFILE LIST START  //////////////////// -->

<?php if($match=="premium_member"){?>
...
<?php if($matchCount<=0 && $match=="suitable-match"){?>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center text-danger pt-20 pb-20">No record(s) found.</div>	
<?php }?>
...
setTimeout(function(){ window.location.href="match-profile-listing.php?match=suitable-match"; },1000);
