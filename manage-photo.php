...
$sql="DELETE FROM tbl_member_image WHERE mem_image_id='$DelID'";
$rs=db_query($sql);

if($rs){
$_SESSION["msg_photo"]="<span class='text-danger bold'>Photo is deleted successfully !</span>";
header("Location: manage-photo.php?memId=$memId");
exit;
...
move_uploaded_file($_FILES['file']['tmp_name'][$i],"member_images/$imgNAME");	
...
header("Location: manage-photo.php?memId=$_REQUEST[memId]");
exit;
}
}
?>
...
<body>
<h1 style="background: #b10a0a;color: #fff;padding: 4px 0;margin: 0 0 12px 0;">Manage Photo Album</h1>
