	...
	if($total_row > 0)
	{
		foreach($result as $row)
		{
			...
			<div class="col-sm-4 col-lg-3 col-md-3">
				<div style="border:1px solid #ccc; border-radius:5px; padding:16px; margin-bottom:16px; height:250px; width:111%; justify-content:center; margin:auto; margin-bottom:5px;">
