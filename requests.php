...
<?php
$sql="SELECT * FROM tbl_registration AS r INNER JOIN tbl_request AS mb ON r.reg_id=mb.request_from WHERE r.reg_status='Active' AND mb.request_to='$userDATA[reg_id]' ORDER BY request_add_date desc";
...
<?php
$waiting_time= $recMemberRecieved['request_add_date']." ".$recMemberRecieved['request_add_time'];?>       
